...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <h3 class="card-title text-center" id="dante">Dante (Devil May Cry Series)</h3>
                <div class="text-center">
                    <img src="DMC Image/DanteDMC5.webp" alt="Dante" class="img-fluid rounded mb-3" style="max-width: 200px;">
                </div>
                <p class="card-text">Dante is a fan favorite known for his charming personality and incredible combat skills</p>
                <h4>Appearances:</h4>
                <ul>
                    <li>Devil May Cry</li>
                ...
                <h4>Weapons:</h4>
                <ul>
                    <li>Swords: Rebellion, Sparda</li>
                    <li>Pistols: Ebony & Ivory</li>
                </ul>
    ...
    <form action="#">
        <fieldset>
            ...
            <input type="radio"> Dante<br>
            <input type="radio"> Vergil<br>
            <input type="radio"> Raiden<br>
            <input type="radio"> Sam<br>
        </fieldset>

        <fieldset>
            <legend>Select your favorite abilities:</legend>
            <input type="checkbox"> Loves pizza<br>
            <input type="checkbox"> Immortality<br>
            <input type="checkbox"> Expert Swordsmanship<br>
            <input type="checkbox"> Top one at having motivation<br>
            <input type="checkbox"> High-Speed Combat<br>
        </fieldset>

        <fieldset>
            <legend>When did you become a fan?</legend>
