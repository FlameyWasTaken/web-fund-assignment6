...
<body>
    ...
    <div class="navbar"> <!-- Навигейшн (Саги) -->
        ...
        <!-- Лого(кружки с крестиком в углу) -->
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <h3 class="card-title text-center" id="Sam">Jetstream Sam (Metal Gear Rising: Revengeance)</h3>
                <div class="text-center">
                    <img src="MGR Image/Sam MGR.webp" alt="Sam" class="img-fluid rounded mb-3" style="max-width: 200px;">
                </div>
                <p class="card-text">Jetstream Sam a.k.a Samuel "Sam" Rodrigues or just Sam is a highly skilled swordsman and 
                    rival to <a href="Raiden.php">Raiden</a> in Metal Gear Rising: Revengeance.</p>
                <h4>Appearances:</h4>
                <ul>
                ...
                <h4>Weapons:</h4>
                <ul>
                    <li>Swords: High-Frequency Blade, HF Murasama (Sam's personal sword)</li>
                </ul>
                <h4>Other Abilities:</h4>
                <ul>
                    <li>Exceptional swordsman</li>
                    <li>Incredible-speed combat skills</li>
                    <li>Honorable combat code</li>
