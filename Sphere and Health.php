...
<div class="navbar"> <!-- Навигейшн (Саги) -->
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Orbs DMC</h1>
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card custom-card">
                    <div class="card-img">
                        <img src="DMC Image/Orbs/DMC3_Red_Orb.jpg" alt="Red_Orb">
                    </div>
                    <div class="card-info">
                        <h3>Red Orb</h3>
                        <p>Red Orbs are magical red stones consisting of the
                            crystallized blood of demons.Throughout the series, the
                            amount of Red Orbs the player finds during a mission factors into its final grade.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card custom-card">
                    <div class="card-img">
                        <img src="DMC Image/Orbs/DMC3_White_Orb.jpg" alt="White_Orb">
                    </div>
                    <div class="card-info">
                        <h3>White_Orb</h3>
                        <p>White Orbs are magical white stones consisting of the crystallized tears and spirit
                            of demons.They will revitalize some of the player's
                            Devil Trigger as soon as they are picked up, and also count towards their Red Orbs
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card custom-card">
                    <div class="card-img">
                        <img src="DMC Image/Orbs/DMC3_Blue_Orb.jpg" alt="Blue_Orb">
                    </div>
                    <div class="card-info">
                        <h3>Blue Orb</h3>
                        <p>Blue Orbs are magical blue stones consisting of crystallized life force.
                            They will lengthen the Vitality Gauge.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card custom-card">
                    <div class="card-img">
                        <img src="DMC Image/Orbs/DMC3_Purple_Orb.jpg" alt="Purple_Orb">
                    </div>
                    <div class="card-info">
                        <h3>Purple Orb</h3>
                        <p>Purple Orbs are magical purple stones consisting of crystallized magic.
                            They will lengthen the Devil Trigger gauge, and thus, the duration the player
                            can be in the Devil Trigger state.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card custom-card">
                    <div class="card-img">
                        <img src="DMC Image/Orbs/DMC3_Green_Orb.jpg" alt="Green_Orb">
                    </div>
                    <div class="card-info">
                        <h3>Green Orb</h3>
                        <p>Green Orbs are magical green stones consisting of the crystallized fluids of demons.
                            They will revitalize some of the player's vitality as soon as they are picked up,
                            also count towards their Red Orbs if their health is already full.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card custom-card">
                    <div class="card-img">
                        <img src="DMC Image/Orbs/DMC3_Gold_and_Yellow_Orb.jpg" alt="Gold_and_Yellow_Orb">
                    </div>
                    <div class="card-info">
                        <h3>Gold and Yellow Orb</h3>
                        <p>Yellow Orbs are magical yellow stones created through a secret alchemical process.
                            When the player dies, they are given the option of using a Yellow Orb
                            to be brought back to life in the previous room.
                        </p>
                    </div>
                </div>
            </div>
