...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <h3 class="card-title text-center" id="Raiden">Raiden (Metal Gear Rising: Revengeance)</h3>
                <div class="text-center">
                    <img src="MGR Image/Raiden MGR.webp" alt="Raiden" class="img-fluid rounded mb-3" style="max-width: 200px;">
                </div>
                <p class="card-text">Raiden is a skilled cyborg ninja who fights for justice with his high-tech sword.</p>
                <h4>Appearances:</h4>
                <ul>
                ...
                <h4>Weapons:</h4>
                <ul>
                    <li>Swords: High-Frequency Blade, High-Frequency Murasama Blade</li>
                    <li>Other: Fists</li>
                </ul>
                <h4>Other Abilities:</h4>
                <ul>
                    <li>Cyborg body with enhanced strength</li>
                    <li>Exceptional swordsman</li>
                    <li>High-speed combat skills</li>
                    <li>Sense of justice</li>
                </ul>
            </div>
        </div>
    </div>
