...
<head>
    ...
    <title>Contact page | Slashers Fandom</title>
...
<body>
    ...
    <form action="https://api.web3forms.com/submit" method="POST">
        <input type="hidden" name="access_key" value="1a61b6e7-98f5-4c43-a470-a3b189a6f0cd">
        <fieldset>
            ...
            <input type="url" name="website" id="link" class="form-control">

            <label for="message">Message:</label>
            <textarea name="message" id="message" rows="4" class="form-control"></textarea>

            <input type="submit" class="subBtn custom-btn" value="Submit">
