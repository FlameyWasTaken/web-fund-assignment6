...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Dante Rebellion Combo</h1>
        <div class="row">
            <div class="video-container">
                <video class="video" autoplay muted loop>
                    <source src="DMC Image/Combo/Rebellion Combo.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Dante Combo (Early Game)</h1>
        <div class="row">
            <div class="video-container">
                <video class="video" autoplay muted loop>
                    <source src="DMC Image/Combo/Dante Combo (Early Game).mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Dante Combo (Late game)</h1>
        <div class="row">
            <div class="video-container">
                <video class="video" autoplay muted loop>
                    <source src="DMC Image/Combo/Dante Combo (Late game).mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
