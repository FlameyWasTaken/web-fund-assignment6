...
<div class="container mt-5">
    <h1 class="text-center mb-4">MGR Raiden Combo</h1>
    <div class="row">
        <div class="video-container">
            <video class="video" autoplay muted loop>
                <source src="MGR Image/Combo/MGR1.mp4" type="video/mp4">
            </video>
        </div>
    </div>
</div>
<div class="container mt-5">
    <h1 class="text-center mb-4">MGR Sam Combo</h1>
    <div class="row">
        <div class="video-container">
            <video class="video" autoplay muted loop>
                <source src="MGR Image/Combo/MGR2.mp4" type="video/mp4">
            </video>
        </div>
    </div>
</div>
